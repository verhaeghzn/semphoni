"""
State configuration for EDAX EDS hardware.
"""
...
DEFAULT_STATE_CONFIG: Dict[str, Any] = {
    ...
    "state_switch_buttons": {
        "spectrum": "SWITCH_TO_SPECTRUM_TAB",
        "map": "SWITCH_TO_MAP_TAB",
    },
    "default_state": "spectrum",
}


class EdaxStateConfig:
    """State configuration manager for EDAX EDS."""
