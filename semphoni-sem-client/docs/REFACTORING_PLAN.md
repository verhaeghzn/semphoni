...
This document outlines the refactoring plan to transform the `semphoni-sem-client` from a TESCAN SEM-specific client into a multi-hardware client supporting:
