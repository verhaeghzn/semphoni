        ...
        <div class="my-6 w-full space-y-6">
            ...
            @if (! $editingId)
                <div class="space-y-4">
                    ...
                    <flux:button variant="primary" wire:click="$set('editingId', null); $set('name', ''); $set('type', 'sftp');">
            ...
            @if ($editingId || $this->storageConfigurations->isEmpty())
                <form wire:submit="save" class="space-y-6">
                    ...
                    <flux:select wire:model="type" :label="__('Storage Type')" required>
                    ...
                    @if ($type === 'sftp')
                        <div class="space-y-4 rounded-lg border border-gray-200 p-4 dark:border-gray-700">
                            ...
                            <flux:input wire:model="sftpHost" :label="__('Host')" type="text" required />
                            ...
                            <flux:input wire:model="sftpRoot" :label="__('Root Path')" type="text" required />
                            <flux:input wire:model="sftpDirectory" :label="__('Directory (optional)')" type="text" />
                    ...
                    @if ($type === 's3')
                        <div class="space-y-4 rounded-lg border border-gray-200 p-4 dark:border-gray-700">
                            ...
                            <flux:input wire:model="s3Region" :label="__('Region')" type="text" required />
                            ...
                            <flux:input wire:model="s3Directory" :label="__('Directory (optional)')" type="text" />
                        </div>
                    @endif
